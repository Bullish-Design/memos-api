...
class MemosAPI:
    ...
    def _setup_routers(self) -> None:
        ...
        # Create router instances with shared storage
        activity_router = ActivityRouter(self.storage.activities)
        attachment_router = AttachmentRouter(self.storage.attachments)
        auth_router = AuthRouter(self.storage.users)
        memo_router = MemoRouter(self.storage.memos)
